...
var EXERCISES = {
  flow: [
    ...
    { id:'f7', name:'Ground-to-Standing Flows', muscles:'Full body, mobility', sets:'30-40s', reps:'continuous', tips:'Find creative ways from ground to standing. No hands if possible.', category:'flow', video:'https://www.youtube.com/watch?v=RNtblbgOKNI' },
    { id:'f8', name:'Hip Circles / Openers', muscles:'Hip flexors, glutes', sets:'30-40s', reps:'each direction', tips:'Large controlled circles. Open hips fully on each rep.', category:'flow', video:'https://www.youtube.com/watch?v=FfXjEFikR0Q' },
  ],
  push: [
    ...
    { id:'p5', name:'Overhead Tricep Extension', muscles:'Triceps', sets:'3', reps:'12', rest:30, tips:'Over head not on head, only move forearm, fully extend, pause at extension.', category:'push', video:'https://www.youtube.com/watch?v=ECNgaxkXjGQ' },
  ...
  pull: [
    ...
    { id:'r6', name:'Hammer Curls', muscles:'Biceps, brachialis', sets:'3', reps:'12', rest:30, tips:"Don't swing, only forearms, stable wrist, arms in front of body.", category:'pull', video:'https://www.youtube.com/watch?v=tYeMmwiwoMQ' },
  ],
  legs: [
  ...
  stretch: [
    ...
    { id:'s7', name:'Happy Baby Pose', muscles:'Inner thighs, hips, lower back', sets:'60s', reps:'hold', tips:'On back, grab outside of feet. Pull knees toward armpits. Rock gently.', category:'stretch', video:'https://www.youtube.com/watch?v=mrPIRr0cwcg' },
  ...
  glute: [
    ...
    { id:'g3', name:'Banded Lateral Walks', muscles:'Glute medius, hip abductors', sets:'3', reps:'12/side', rest:22, tips:'Band above knees, quarter squat. Step sideways keeping tension. Stay low, don\'t let knees cave.', category:'glute', video:'https://www.youtube.com/watch?v=iMfhj85F8OA' },
    { id:'g4', name:'Single-Leg Deadlift', muscles:'Hamstrings, glutes, balance', sets:'3', reps:'10/leg', rest:30, tips:'Hinge at hip on one leg, back leg extends behind. Keep back flat, slight knee bend. DB in opposite hand.', category:'glute', video:'https://www.youtube.com/watch?v=iDKmW_fH45Q' },
    { id:'g5', name:'Donkey Kicks', muscles:'Glutes', sets:'3', reps:'15/leg', rest:15, tips:'On all fours, drive one heel toward ceiling. Squeeze glute at top. Don\'t arch lower back.', category:'glute', video:'https://www.youtube.com/watch?v=IExuMOhSu68' },
    { id:'g6', name:'Fire Hydrants', muscles:'Glute medius, hip abductors', sets:'3', reps:'15/leg', rest:15, tips:'On all fours, lift knee out to side keeping 90° bend. Control the movement. Squeeze at top.', category:'glute', video:'https://www.youtube.com/watch?v=La3xYBMpNbE' },
  ],
  abs: [
    ...
    { id:'ab4', name:'Flutter Kicks', muscles:'Lower abs, hip flexors', sets:'3', reps:'30s', rest:15, tips:'Lie flat, lift legs 6 inches, alternate small kicks. Keep lower back pressed to floor. Breathe steadily.', category:'abs', video:'https://www.youtube.com/watch?v=eEG9uXSMreA' },
    ...
    { id:'ab6', name:'Hollow Body Hold', muscles:'Deep core, rectus abdominis', sets:'3', reps:'20-30s hold', rest:15, tips:'On back, arms overhead, legs straight and lifted. Press lower back into floor. Hold position. Scale by bending knees.', category:'abs', video:'https://www.youtube.com/watch?v=1M2jnp2RFbg' },
  ...
  senior: [
    { id:'sr1', name:'Gentle Walking', muscles:'Cardio, legs, endurance', sets:'1', reps:'10-15 min', tips:'Walk at a comfortable pace. Focus on good posture — head up, shoulders back, arms swinging naturally. Breathe steadily.', category:'senior', video:'https://www.youtube.com/watch?v=n8_FZ7bORVw' },
    { id:'sr2', name:'Chair Squats', muscles:'Quads, glutes', sets:'2', reps:'8-10', rest:30, tips:'Stand in front of a sturdy chair. Sit back slowly until you lightly touch the seat, then stand back up. Use armrests if needed.', category:'senior', video:'https://www.youtube.com/watch?v=MVU1j4l0rMU' },
    { id:'sr3', name:'Wall Push-ups', muscles:'Chest, shoulders, triceps', sets:'2', reps:'8-10', rest:30, tips:'Hands on wall at shoulder height, shoulder-width apart. Lean in, push back. Keep body straight. Easy on the wrists.', category:'senior', video:'https://www.youtube.com/watch?v=a6YHbXD2XlU' },
    { id:'sr4', name:'Seated Shoulder Press', muscles:'Shoulders, triceps', sets:'2', reps:'8-10', rest:30, tips:'Sit in a sturdy chair. Use very light dumbbells (2-5 lbs) or water bottles. Press overhead slowly, lower with control.', category:'senior', video:'https://www.youtube.com/watch?v=Gu7IAn_XBXY' },
    ...
    { id:'sr6', name:'Heel-to-Toe Walk', muscles:'Balance, calves, ankles', sets:'1', reps:'2 lengths (20 steps)', tips:'Walk in a straight line placing heel directly in front of opposite toe. Use a wall or counter for balance support. Go slowly.', category:'senior', video:'https://www.youtube.com/watch?v=JTxOGihG5_U' },
    ...
    { id:'sr9', name:'Arm Circles', muscles:'Shoulders, rotator cuff', sets:'1', reps:'10 each direction', tips:'Arms out to sides at shoulder height. Small circles forward, then backward. Keep shoulders relaxed. No weights needed.', category:'senior', video:'https://www.youtube.com/watch?v=bPKnHJHb4F4' },
    { id:'sr10', name:'Standing Hip Abduction (Chair)', muscles:'Hip abductors, glutes, balance', sets:'2', reps:'8/leg', rest:22, tips:'Hold chair for support. Lift one leg out to the side, keep toes forward. Lower slowly. Don\'t lean to the side.', category:'senior', video:'https://www.youtube.com/watch?v=jghbMRmej3E' },
    { id:'sr11', name:'Single-Leg Stand (Chair)', muscles:'Balance, ankles, core', sets:'1', reps:'20s/leg', tips:'Hold chair lightly with one hand. Lift one foot slightly off floor. Hold 20 seconds. Try to gradually use less hand support.', category:'senior', video:'https://www.youtube.com/watch?v=fp0FoLw0jKk' },
    ...
    { id:'sr14', name:'Seated Torso Twist', muscles:'Obliques, spine mobility', sets:'1', reps:'8 each side', tips:'Sit tall in chair, hands on shoulders. Rotate torso left and right slowly. Keep hips facing forward. Breathe naturally.', category:'senior', video:'https://www.youtube.com/watch?v=6GcBTU5bD00' },
    ...
    { id:'sr16', name:'Gentle Step-ups', muscles:'Quads, glutes, balance', sets:'2', reps:'6/leg', rest:30, tips:'Use a low step (4-6 inches) or bottom stair. Step up with one foot, bring the other up, step back down. Hold railing for support.', category:'senior', video:'https://www.youtube.com/watch?v=dQqApCGd5Cw' },
  ]
};
